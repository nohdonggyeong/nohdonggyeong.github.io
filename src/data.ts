...
export const sideProjects: Project[] = [
  {
    ...
    summary: ["병원 업무 기록 조회·요약·제안 AI 비서 PoC"],
    detail: ["매 치료마다 반복되는 이전 기록 확인·처방 파악·기록 작성 과정을 자연어 질의로 대체하는 도메인 특화 AI 비서 개발 PoC 진행"],
    contributions: [
      "LangGraph로 Orchestrator, Data Fetcher, Responder 멀티 에이전트 구성",
      "FastMCP 기반 Tool Server 구현(치료 항목 설명 등 6개 도구)",
